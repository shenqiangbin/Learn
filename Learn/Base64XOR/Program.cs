...
//              var url = "CreateModeSelector.aspx?" + query;
...
//            query = UtilityCs.Base64.DecodeBase64(Encoding.UTF8, query);
//            var nameValueCollection = HttpUtility.ParseQueryString(query, Encoding.UTF8);
